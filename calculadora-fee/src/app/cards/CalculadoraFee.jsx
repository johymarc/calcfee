...
//   1. loadContext()  -> carrega propriedades do Ticket + empresas (HubDB)
...
const CalculadoraFee = ({ context, runServerlessFunction, actions }) => {
  ...
  // ── Empresa selecionada + dados carregados da tabela HubDB ─────────────
  ...
  //   1. tabela vazia (nenhuma empresa carregada)
          ...
          <Box padding="small" backgroundColor="light">
            <Flex direction="row" align="center" gap="extra-small">
              ...
              <Text format={{ color: "medium", italic: true }}>
                Tabela HubDB vazia — sem empresas disponíveis.
              </Text>
            </Flex>
          </Box>
        </Field>
  ...
  const CardHeader = () => (
    <Flex direction="row" align="center" gap="extra-small">
      ...
      <Heading level={4}>Calculadora de FEE</Heading>
    </Flex>
  );
